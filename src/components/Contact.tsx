			...
			>
				...
				<div className="flex flex-row flex-wrap justify-start gap-6 my-3">
					<Link
						...
						target="_blank"
						className="rounded-full bg-tertiary w-14 h-14 flex justify-center items-center shadow-sm shadow-secondary"
					>
						<MdMailOutline className="w-[80%] h-[80%] rounded-full text-secondary" />
					</Link>
					<Link
						to="https://www.linkedin.com/in/hyonam-bassey-482191207"
						target="_blank"
						className="rounded-full bg-tertiary w-14 h-14 flex justify-center items-center shadow-sm shadow-secondary"
					>
